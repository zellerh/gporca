...
//---------------------------------------------------------------------------
#ifndef GPOPT_CJoinOrderDynProg_H
#define GPOPT_CJoinOrderDynProg_H
...
namespace gpopt
{
	...
	//
	//---------------------------------------------------------------------------
	class CJoinOrderDynProg : public CJoinOrder
	{
	...
	}; // class CJoinOrderDynProg

}

#endif // !GPOPT_CJoinOrderDynProg_H
