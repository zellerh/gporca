...
if os.environ['skip_tests'] != "":
    build_and_test_flags = "--skip_tests"
if build_type == 'DEBUG':
...
build_and_test_orca_cmd = "orca_main_src/concourse/build_and_test.py --build_type={0} --output_dir={1}/install bin_xerces_centos5 {2}".format(build_type, outputDirectory, build_and_test_flags)
