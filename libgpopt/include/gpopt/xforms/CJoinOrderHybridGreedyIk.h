...
//
//	@filename:
//		CJoinOrderHybridGreedyIk.h
//
//	@doc:
//		Dynamic programming-based join order generation
//---------------------------------------------------------------------------
#ifndef GPOPT_CJoinOrderHybridGreedyIk_H
#define GPOPT_CJoinOrderHybridGreedyIk_H
...
namespace gpopt
{
	...
	//---------------------------------------------------------------------------
	//	@class:
	//		CJoinOrderHybridGreedyIk
	//
	//	@doc:
	//		Helper class for creating join orders using dynamic programming
	//
	//---------------------------------------------------------------------------
	class CJoinOrderHybridGreedyIk : public CJoinOrder
	{
	...
	}; // class CJoinOrderHybridGreedyIk

}

#endif // !GPOPT_CJoinOrderHybridGreedyIk_H
