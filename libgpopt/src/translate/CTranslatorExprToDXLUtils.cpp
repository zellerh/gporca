	...
	)
{
	...
	pmdidScCmp = CUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypeOther, pmdidTypePartKey, cmp_type);
	...
	)
{
	...
	{
		pmdidScCmp = CUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypeCastExpr, pmdidTypeExpr, cmp_type);
	}
	else
	{
		pmdidScCmp = CUtils::GetScCmpMdIdConsiderCasts(md_accessor, pmdidTypePartKey, pmdidTypeExpr, cmp_type);
	}
